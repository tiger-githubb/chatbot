...
class TestConfiguration:
    ...
    def test_config_loads(self):
        ...
        try:
            ...
            pytest.fail(f"Erreur de chargement de configuration: {e}")
    ...
    def test_main_app_creation(self):
        ...
        try:
            ...
            pytest.fail(f"Erreur de création de l'app FastAPI: {e}")
...
class TestApplicationStructure:
    ...
    def test_api_endpoints_defined(self):
        ...
        try:
            ...
            pytest.fail(f"Erreur de définition des endpoints: {e}")
